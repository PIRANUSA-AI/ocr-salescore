...
>(({ className, indeterminate, ...props }, ref) => {
  ...
  React.useEffect(() => {
    ...
    if (combinedRef && 'current' in combinedRef && combinedRef.current) {
      combinedRef.current.dataset.state = indeterminate ? "indeterminate" : props.checked ? "checked" : "unchecked";
      (combinedRef.current as any).indeterminate = indeterminate ?? false;
    }
